...
def send_submit_request():
    ...
    payload = {
        "data": "https://github.com/BaGGeRTeaMYT/Consultation-code",
        "requirements": {
            "Проект написан на языке программирования Java": 1,
            ...
            "Используемые в проекте алгоритмы имеют максимум квадратичную сложность": 1,
        },
        "data_type": 0,
    }
    EXPECTED_ROLES = {
