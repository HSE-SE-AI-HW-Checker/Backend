...
def test_sign_in_nonexistent_user():
    ...
    print("✓ Несуществующий пользователь обработан корректно")
...
if __name__ == "__main__":
    print("=" * 50)
    print("Запуск теста успешной авторизации")
    print("=" * 50)
    test_sign_in_success()
    
    print("\n" + "=" * 50)
    print("Запуск теста авторизации с неверным паролем")
    print("=" * 50)
    test_sign_in_wrong_password()
    
    print("\n" + "=" * 50)
    print("Запуск теста авторизации несуществующего пользователя")
    print("=" * 50)
